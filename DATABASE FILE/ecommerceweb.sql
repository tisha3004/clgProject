...
CREATE TABLE `tbl_settings` (
  `id` int(11) NOT NULL,
  `logo` varchar(100) NOT NULL, -- Adjusted column size
  `favicon` varchar(100) NOT NULL, -- Adjusted column size
  `footer_about` text NOT NULL,
  `footer_copyright` text NOT NULL,
  `contact_address` text NOT NULL,
  `contact_email` varchar(100) NOT NULL, -- Adjusted column size
  `contact_phone` varchar(20) NOT NULL, -- Adjusted column size
  `contact_fax` varchar(20) NOT NULL, -- Adjusted column size
  `contact_map_iframe` text NOT NULL,
  `receive_email` varchar(100) NOT NULL, -- Adjusted column size
  `receive_email_subject` varchar(100) NOT NULL, -- Adjusted column size
...
VALUES (
    ...
    'logo.png', 
    'favicon.png', 
    '<p>Lorem ipsum dolor sit amet, omnis signiferumque in mei, mei ex enim concludaturque. Senserit salutandi euripidis no per, modus maiestatis scribentur est an. Ea suas pertinax has.</p>\r\n', 
    'Copyright Â© 2022 - Ecommerce Website PHP - Developed By Hammad Hassan', 
    '93 Simpson Avenue, Harrisburg, PA', 
    'support@ecommercephp.com', 
    '+001 10 101 0010', 
    '', 
    ...
    'support@ecommercephp.com', 
    'Visitor Email Message from Ecommerce Site PHP', 
    'Thank you for sending email. We will contact you shortly.', 
    ...
    'ecommerce php project with mysql database', 
    'banner_login.jpg', 
    ...
    'cta.jpg', 
    'Featured Products', 
    'Our list on Top Featured Products', 
    'Latest Products', 
    'Our list of recently added products', 
    'Popular Products', 
    'Popular products based on customer\'s choice', 
    'Testimonials', 
    'See what our clients tell about us', 
    'testimonial.jpg', 
    'Latest Blog', 
    'See all our latest articles and news from below', 
    'Sign-up to our newsletter for latest promotions and discounts.', 
    'admin@ecom.com', 
